...
from src.inference import penalties
...
class Beam:
    ...
    def advance(self, word_logits, attn_dist):
        ...
        * `attn_dist`- attention at the last step [beam_size, src_len]
        ...
        prev_k = torch.div(best_scores_idx, vocab_size, rounding_mode='trunc')  # convert it to the beam indices that the top k scores came from, LongTensor, size: [beam_size]
